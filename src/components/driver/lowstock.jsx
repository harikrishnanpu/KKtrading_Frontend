       ...
       {!driverPage && <div className="border border-gray-200 rounded-lg p-4">
          ...
          {filteredProducts.length === 0 ? (
            ...
            filteredProducts.map((product) => (
              <div                   onClick={() => navigate(`/invoice/need-to-purchase`)}
              key={product.item_id} className="flex cursor-pointer hover:bg-gray-100 rounded-md justify-between items-center p-3 border-b border-gray-200">
