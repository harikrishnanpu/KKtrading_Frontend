...
import { deleteStory, useGetBacklogs, useGetUsers } from 'api/taskboard';
...
export default function UserStory({ story, index }) {
  ...
  const storyProfile = users?.filter((user) => user._id === story.assign)[0];
        ...
        {(provided, snapshot) => (
          <>
            ...
            >
              ...
              <TableCell sx={{ width: 140, minWidth: 140 }}>  {storyProfile ? storyProfile.name : 'Unassigned'}</TableCell>
