...
import { deleteItem, handleTaskboardDialog, useGetBacklogs, useGetUsers } from 'api/taskboard';
...
export default function Items({ itemId, index }) {
  ...
  const itemProfile = users?.filter((profile) => profile._id === item.assign)[0];

  const handlerDetails = () => {
    handleTaskboardDialog(itemId);
  };
