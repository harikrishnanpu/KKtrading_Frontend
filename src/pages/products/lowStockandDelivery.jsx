            ...
            {displayedBillings.length > 0 ? (
              <ul className="space-y-3">
                {displayedBillings.map((bill) => (
                  <li onClick={()=> navigate(`/invoice/details/${bill._id}`)} key={bill.invoiceNo} className="flex cursor-pointer flex-col bg-gray-50 p-4 rounded-md hover:bg-gray-100 transition">
